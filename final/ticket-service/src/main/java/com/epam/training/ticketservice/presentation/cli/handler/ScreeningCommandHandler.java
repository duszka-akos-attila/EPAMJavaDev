...
public class ScreeningCommandHandler {
    ...
    public String createScreening(String movieName, String roomName, Date screeningTime){
        return "Created a new screening for: \""+ movieName +"\" at \""+ roomName +"\"!";
    }
    ...
    public String updateScreening(String movieName, String roomName, Date screeningTime){
        return "Updated the screening: \""+ movieName +"\" at \""+ roomName +"\"!";
    }

    @ShellMethod(value = "Deletes an existing screening", key = "delete screening")
    public String deleteScreening(String movieName, String roomName){
        return "Deleted the the screening: \""+ movieName +"\" at \""+ roomName +"\"!";
    }
}